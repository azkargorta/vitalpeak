...
CARDIO_EXERCISES = [
    ...
    {"name": "Escaladora", "group": "Cardio", "cardio": True, "cardioType": "stair-climber", "cues": ["Evita descargar el peso sobre las manos.", "Usa pasos controlados y regula el ritmo para mantener la intensidad objetivo."], "animation": {"path": "cardio-images/escaladora.svg", "kind": "image"}},
    {"name": "Saltar a la comba", "group": "Cardio", "cardio": True, "cardioType": "jump-rope", "cues": ["Haz saltos bajos y suaves, principalmente desde los tobillos.", "Mantén los codos cerca del cuerpo y mueve la cuerda con las muñecas."], "animation": {"path": "cardio-images/saltar-comba.svg", "kind": "image"}},
    {"name": "Carrera exterior", "group": "Cardio", "cardio": True, "cardioType": "running", "cues": ["Empieza suave y aumenta progresivamente el ritmo.", "Adapta el esfuerzo al terreno y a las condiciones del día."], "animation": {"path": "cardio-images/carrera-exterior.svg", "kind": "image"}},
    {"name": "Caminata rápida", "group": "Cardio", "cardio": True, "cardioType": "walking", "cues": ["Busca un paso vivo que puedas mantener sin perder postura.", "Usa el movimiento natural de brazos para acompañar el ritmo."], "animation": {"path": "cardio-images/caminata-rapida.svg", "kind": "image"}},
]
