...
def main() -> None:
    ...
    OUTPUT.write_text(
        ...
        "};\n"
        "for (const src of ['./routine-enhancements.js?v=33', './calendar-mobile.js?v=33', './training-intelligence.js?v=33', './routine-navigation-fix.js?v=33', './routines-accordion.js?v=33']) {\n"
