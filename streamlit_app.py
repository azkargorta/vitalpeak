...
if page == "🔐 Login / Registro":
    ...
    with col2:
            ...
            agrupacion = st.selectbox(
                ...
                index=0,
                help="Combinar varios grupos principales en un día o centrarse en uno."
            )
            comentarios = st.text_area(
                "Comentarios y observaciones (opcional)",
                placeholder="Ej.: solo un día pierna/glúteo • añadir 1 día de cardio + core • evitar press militar...",
                height=120
            )
