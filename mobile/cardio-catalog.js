(() => {
  ...
  const cardioExercises = [
    { name:'Cinta de correr', group:'Cardio', cardio:true, cardioType:'treadmill', cues:['Empieza con unos minutos suaves antes de subir el ritmo.','Mantén una zancada natural y evita agarrarte a la consola salvo necesidad.'], animation:{kind:'gif',path:'cardio-gifs/cinta-de-correr/movimiento.gif'} },
    { name:'Caminata en cinta con inclinación', group:'Cardio', cardio:true, cardioType:'treadmill', cues:['Mantén el tronco erguido y una inclinación que puedas sostener con buena técnica.','Ajusta velocidad e inclinación para controlar la intensidad sin tener que correr.'], animation:{kind:'gif',path:'cardio-gifs/caminata-cinta-inclinacion/movimiento.gif'} },
    { name:'Bicicleta estática', group:'Cardio', cardio:true, cardioType:'bike', cues:['Ajusta el sillín para que la rodilla quede ligeramente flexionada abajo.','Pedalea de forma fluida y controla la resistencia sin perder cadencia.'], animation:{kind:'gif',path:'cardio-gifs/bicicleta-estatica/movimiento.gif'} },
    { name:'Bicicleta de aire', group:'Cardio', cardio:true, cardioType:'air-bike', cues:['Empuja y tira con brazos mientras mantienes un pedaleo constante.','En intervalos intensos prioriza una postura estable antes que la velocidad máxima.'], animation:{kind:'gif',path:'cardio-gifs/bicicleta-aire/movimiento.gif'} },
    { name:'Bicicleta elíptica', group:'Cardio', cardio:true, cardioType:'elliptical', cues:['Mantén el apoyo completo del pie y el tronco estable.','Aumenta resistencia antes de acelerar si buscas más intensidad con menos impacto.'], animation:{kind:'gif',path:'cardio-gifs/bicicleta-eliptica/movimiento.gif'} },
    { name:'Remo ergómetro', group:'Cardio', cardio:true, cardioType:'rower', cues:['Empuja primero con las piernas, después acompaña con tronco y brazos.','En la vuelta recupera brazos, tronco y finalmente piernas.'], animation:{kind:'gif',path:'cardio-gifs/remo-ergometro/movimiento.gif'} },
    { name:'Escaladora', group:'Cardio', cardio:true, cardioType:'stair-climber', cues:['Evita descargar el peso sobre las manos.','Usa pasos controlados y regula el ritmo para mantener la intensidad objetivo.'], animation:{kind:'gif',path:'cardio-gifs/escaladora/movimiento.gif'} },
    { name:'Saltar a la comba', group:'Cardio', cardio:true, cardioType:'jump-rope', cues:['Haz saltos bajos y suaves, principalmente desde los tobillos.','Mantén los codos cerca del cuerpo y mueve la cuerda con las muñecas.'], animation:{kind:'gif',path:'cardio-gifs/saltar-comba/movimiento.gif'} },
    { name:'Carrera exterior', group:'Cardio', cardio:true, cardioType:'running', cues:['Empieza suave y aumenta progresivamente el ritmo.','Adapta el esfuerzo al terreno y a las condiciones del día.'], animation:{kind:'gif',path:'cardio-gifs/carrera-exterior/movimiento.gif'} },
    { name:'Caminata rápida', group:'Cardio', cardio:true, cardioType:'walking', cues:['Busca un paso vivo que puedas mantener sin perder postura.','Usa el movimiento natural de brazos para acompañar el ritmo.'], animation:{kind:'gif',path:'cardio-gifs/caminata-rapida/movimiento.gif'} }
  ];
