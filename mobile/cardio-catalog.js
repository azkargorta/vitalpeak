(() => {
  ...
  const cardioExercises = [
    ...
    { name:'Escaladora', group:'Cardio', cardio:true, cardioType:'stair-climber', cues:['Evita descargar el peso sobre las manos.','Usa pasos controlados y regula el ritmo para mantener la intensidad objetivo.'], animation:{kind:'image',path:'cardio-images/escaladora.svg'} },
    { name:'Saltar a la comba', group:'Cardio', cardio:true, cardioType:'jump-rope', cues:['Haz saltos bajos y suaves, principalmente desde los tobillos.','Mantén los codos cerca del cuerpo y mueve la cuerda con las muñecas.'], animation:{kind:'image',path:'cardio-images/saltar-comba.svg'} },
    { name:'Carrera exterior', group:'Cardio', cardio:true, cardioType:'running', cues:['Empieza suave y aumenta progresivamente el ritmo.','Adapta el esfuerzo al terreno y a las condiciones del día.'], animation:{kind:'image',path:'cardio-images/carrera-exterior.svg'} },
    { name:'Caminata rápida', group:'Cardio', cardio:true, cardioType:'walking', cues:['Busca un paso vivo que puedas mantener sin perder postura.','Usa el movimiento natural de brazos para acompañar el ritmo.'], animation:{kind:'image',path:'cardio-images/caminata-rapida.svg'} }
  ];
